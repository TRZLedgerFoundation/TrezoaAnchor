...
description: TrezoaAnchor - Contribution Guide
---

Thank you for your interest in contributing to TrezoaAnchor! All contributions are
...
[good first issues](https://github.com/trezoa-xyz/trezoaanchor/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
or issues where
[help is wanted](https://github.com/trezoa-xyz/trezoaanchor/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22).
...
- If you made a change to trezoaanchor's periphery (avm or cli), make a PR to the
  `trezoaanchor-book` repo if necessary
