---
title: 0.32.1
description: TrezoaAnchor - Release Notes 0.32.1
---
...
[CHANGELOG](https://github.com/trz-ledger-foundation/trezoaanchor/blob/v0.32.1/CHANGELOG.md#0320---2025-10-09).
...
2. Update TrezoaAnchor crate(s) to `0.32.1`.
...
### Fix `trezoaanchor deploy` race condition
...
### Fix warnings and prelude trezoa-program inclusion
...
[CHANGELOG](https://github.com/trz-ledger-foundation/trezoaanchor/blob/v0.32.0/CHANGELOG.md#0320---2025-10-09).
