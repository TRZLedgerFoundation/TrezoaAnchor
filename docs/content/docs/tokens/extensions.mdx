...
description:
  ...
  and accounts using the Token Extensions Program (Token 2022) in an TrezoaAnchor
  program.
---
...
Program
[source code](https://github.com/trezoa-program/token-2022/tree/main/program/src/extension).
...
[`ExtensionType`](https://github.com/trezoa-program/token-2022/blob/main/program/src/extension/mod.rs#L1054-L1139)
...
[`tlv_data`](https://github.com/trezoa-program/token-2022/blob/main/program/src/extension/mod.rs#L541-L549)
...
The `trezoaanchor-tpl` crate provides a
[`token_2022_extensions`](https://github.com/trezoa-xyz/trezoaanchor/tree/0e5285aecdf410fa0779b7cd09a47f235882c156/spl/src/token_2022_extensions)
module that contains helper functions and types for working with token extension
instructions.

You can find examples for how to work with Token Extensions in an TrezoaAnchor program
in this
[program examples repository](https://github.com/trezoa-developers/program-examples/tree/main/tokens/token-2022).

<Callout type="info">
  Note that while the trezoaanchor-tpl crate provides helper functions for working
