...
description:
  ...
  invocations (CPIs) in TrezoaAnchor.
---
...
[`transfer_checked`](https://github.com/trezoa-program/token/blob/main/program/src/instruction.rs#L1235-L1265)
...
<Callout type="info">
  The [Token
  Program](https://github.com/trezoa-program/token/blob/main/program/src/processor.rs#L229-L343)
  and [Token Extension
  Program](https://github.com/trezoa-program/token-2022/blob/main/program/src/processor.rs#L290-L561)
  share similar implementations to achieve the same functionality.
</Callout>

## Examples

To transfer tokens through an TrezoaAnchor program, you need to make a cross program
...
use trezoaanchor_spl::token_interface::{self, TokenAccount, TokenInterface, TransferChecked};
...
describe("token-example", () => {
  ...
  it("Is initialized!", async () => {
    const tx = await program.methods
      .createAndMintTokens(new trezoaanchor.BN(100))
      .accounts({
