---
title: TrezoaAnchor Version Manager
description: AVM reference documentation
---

TrezoaAnchor Version Manager (avm) is provided to manage multiple installations of the
trezoaanchor-cli binary. This may be required to produce verifiable builds, or if
you'd prefer to work with an alternate version.

---

```shell
TrezoaAnchor version manager
...
SUBCOMMANDS:
    ...
    install      Install a version of TrezoaAnchor
    list         List available versions of TrezoaAnchor
    uninstall    Uninstall a version of TrezoaAnchor
    use          Use a specific version of TrezoaAnchor
```
...
Install the specified version of trezoaanchor-cli. The version argument should follow
