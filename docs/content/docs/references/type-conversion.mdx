...
description: Reference for how TrezoaAnchor converts between Rust and TypeScript types
---
...
| `u64/u128/i64/i128`     | `trezoaanchor.BN` | `new trezoaanchor.BN(99)` |
| `f32/f64`               | `number`    | `1.0`               |
...
- Larger integers (`u64` and above) use TrezoaAnchor's `BN` type for precision
