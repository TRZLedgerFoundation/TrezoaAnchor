...
- Upgrading Trezoa to `1.16`. The difference in compute units usage between `0.27.0` and `0.28.0` is the direct result of upgrading Trezoa version(both build tools and crates) ([#2512](https://github.com/TRZLedgerFoundation/TrezoaAnchor/pull/2512)).
