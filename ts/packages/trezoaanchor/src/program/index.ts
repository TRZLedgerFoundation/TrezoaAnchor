import { Commitment, PublicKey } from "@trezoa/web3.js";
 ...
 * ## Program
 *
 * Program provides the IDL deserialized client representation of an TrezoaAnchor
 * program.
 *
...
export class Program<IDL extends Idl = Idl> {
   ...
   * via the trezoaanchor CLI's `trezoaanchor idl init` command.
   *
