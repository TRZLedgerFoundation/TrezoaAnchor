import { ProgramErrorStack, TrezoaAnchorError } from "../src/error";
...
describe("ProgramErrorStack", () => {
  ...
  it("failed inner ix", () => {
    const logs = [
      ...
      "Program log: TrezoaAnchorError thrown in programs/switchboard_v2/src/actions/aggregator_save_result_action.rs:235. Error Code: OracleMismatchError. Error Number: 6021. Error Message: An unexpected oracle account was provided for the transaction..",
...
describe("TrezoaAnchorError", () => {
  it("FileLine TrezoaAnchorError with Pubkeys", () => {
    const logs = [
    ...
    const trezoaanchorError = TrezoaAnchorError.parse(logs)!;
    expect(trezoaanchorError.program.toString()).toEqual(
      "SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f"
    );
    expect(trezoaanchorError.error.errorCode).toEqual({
      code: "OracleMismatchError",
      number: 6021,
    });
    expect(trezoaanchorError.error.errorMessage).toEqual(
      "An unexpected oracle account was provided for the transaction."
    );
    expect(trezoaanchorError.error.origin).toEqual({
      file: "programs/switchboard_v2/src/actions/aggregator_save_result_action.rs",
      line: 235,
    });
    expect(
      trezoaanchorError.error.comparedValues!.map((pk) => pk.toString())
    ).toEqual([
      "Fg6PaFpoGXkYsidMpWTK6W2BeZ7FEfcYkg476zPFsLnS",
      "SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f",
    ]);
    expect(
      trezoaanchorError.programErrorStack!.map((publicKey) => publicKey.toString())
    ).toEqual(["SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f"]);
    expect(trezoaanchorError.errorLogs).toEqual([
      "Program log: TrezoaAnchorError thrown in programs/switchboard_v2/src/actions/aggregator_save_result_action.rs:235. Error Code: OracleMismatchError. Error Number: 6021. Error Message: An unexpected oracle account was provided for the transaction..",
      "Program log: Left:",
      "Program log: Fg6PaFpoGXkYsidMpWTK6W2BeZ7FEfcYkg476zPFsLnS",
      "Program log: Right:",
  ...
  it("FileLine TrezoaAnchorError with Values", () => {
    const logs = [
      "Program SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f invoke [1]",
      "Program log: Instruction: AggregatorSaveResult",
      "Program log: TrezoaAnchorError thrown in programs/switchboard_v2/src/actions/aggregator_save_result_action.rs:235. Error Code: OracleMismatchError. Error Number: 6021. Error Message: An unexpected oracle account was provided for the transaction..",
    ...
    expect(trezoaanchorError.error.comparedValues!).toEqual(["1337", "4220"]);
    expect(
      trezoaanchorError.programErrorStack!.map((publicKey) => publicKey.toString())
    ).toEqual(["SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f"]);
    expect(trezoaanchorError.errorLogs).toEqual([
  ...
  it("AccountName TrezoaAnchorError with Pubkeys", () => {
    const logs = [
      "Program SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f invoke [1]",
      "Program log: Instruction: AggregatorSaveResult",
      "Program log: TrezoaAnchorError caused by account: some_account. Error Code: OracleMismatchError. Error Number: 6021. Error Message: An unexpected oracle account was provided for the transaction..",
      "Program log: Left:",
      "Program log: Fg6PaFpoGXkYsidMpWTK6W2BeZ7FEfcYkg476zPFsLnS",
      "Program log: Right:",
      "Program log: SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f",
    ...
    expect(trezoaanchorError.error.origin).toEqual("some_account");
    expect(
      trezoaanchorError.error.comparedValues!.map((pk) => pk.toString())
    ).toEqual([
      "Fg6PaFpoGXkYsidMpWTK6W2BeZ7FEfcYkg476zPFsLnS",
  ...
  it("AccountName TrezoaAnchorError with Values", () => {
    const logs = [
      "Program SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f invoke [1]",
      "Program log: Instruction: AggregatorSaveResult",
      "Program log: TrezoaAnchorError caused by account: some_account. Error Code: OracleMismatchError. Error Number: 6021. Error Message: An unexpected oracle account was provided for the transaction..",
  ...
  it("Empty TrezoaAnchorError", () => {
    const logs = [
      "Program SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f invoke [1]",
      "Program log: Instruction: AggregatorSaveResult",
      "Program log: TrezoaAnchorError occurred. Error Code: OracleMismatchError. Error Number: 6021. Error Message: An unexpected oracle account was provided for the transaction..",
      "Program SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f consumed 28928 of 200000 compute units",
      "Program SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f failed: custom program error: 0x1785",
    ];
    ...
    expect(trezoaanchorError.error.origin).toBeUndefined();
    expect(trezoaanchorError.error.comparedValues).toBeUndefined();
    expect(
      trezoaanchorError.programErrorStack!.map((publicKey) => publicKey.toString())
    ).toEqual(["SW1TCH7qEPTdLsDHRgPuMQjbQxKdH2aBStViMFnt64f"]);
    expect(trezoaanchorError.errorLogs).toEqual([
