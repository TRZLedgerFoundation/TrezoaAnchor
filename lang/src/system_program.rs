...
pub use crate::trezoa_program::system_program::ID;

#[derive(Debug, Clone)]
pub struct System;

impl trezoaanchor-lang::Id for System {
    fn id() -> Pubkey {
        ID
    }
}
...
pub fn advance_nonce_account<'info>(
    ...
    let ix = crate::trezoa_program::system_instruction::advance_nonce_account(
        ctx.accounts.nonce.key,
        ctx.accounts.authorized.key,
    );
    crate::trezoa_program::program::invoke_signed(
        &ix,
        &[
            ctx.accounts.nonce,
...
pub fn allocate<'info>(
    ...
    let ix = crate::trezoa_program::system_instruction::allocate(
...
pub fn allocate_with_seed<'info>(
    ...
    let ix = crate::trezoa_program::system_instruction::allocate_with_seed(
        ctx.accounts.account_to_allocate.key,
...
pub fn assign<'info>(
    ...
    let ix = crate::trezoa_program::system_instruction::assign(
...
pub fn assign_with_seed<'info>(
    ...
    let ix = crate::trezoa_program::system_instruction::assign_with_seed(
        ctx.accounts.account_to_assign.key,
        ctx.accounts.base.key,
        seed,
        owner,
...
pub fn authorize_nonce_account<'info>(
    ...
    let ix = crate::trezoa_program::system_instruction::authorize_nonce_account(
        ctx.accounts.nonce.key,
        ctx.accounts.authorized.key,
        new_authority,
    );
...
pub fn create_account<'info>(
    ...
    let ix = crate::trezoa_program::system_instruction::create_account(
...
pub fn create_account_with_seed<'info>(
    ...
    let ix = crate::trezoa_program::system_instruction::create_account_with_seed(
        ctx.accounts.from.key,
        ctx.accounts.to.key,
        ctx.accounts.base.key,
        seed,
...
pub fn create_nonce_account<'info>(
    ...
    let ixs = crate::trezoa_program::system_instruction::create_nonce_account(
        ctx.accounts.from.key,
        ctx.accounts.nonce.key,
        authority,
        lamports,
...
pub fn create_nonce_account_with_seed<'info>(
    ...
    let ixs = crate::trezoa_program::system_instruction::create_nonce_account_with_seed(
        ctx.accounts.from.key,
        ctx.accounts.nonce.key,
        ctx.accounts.base.key,
        seed,
...
pub fn transfer<'info>(
    ...
    let ix = crate::trezoa_program::system_instruction::transfer(
        ctx.accounts.from.key,
        ctx.accounts.to.key,
        lamports,
    );
...
pub fn transfer_with_seed<'info>(
    ...
    let ix = crate::trezoa_program::system_instruction::transfer_with_seed(
        ctx.accounts.from.key,
        ctx.accounts.base.key,
        from_seed,
        from_owner,
...
pub fn withdraw_nonce_account<'info>(
    ...
    let ix = crate::trezoa_program::system_instruction::withdraw_nonce_account(
        ctx.accounts.nonce.key,
        ctx.accounts.authorized.key,
        ctx.accounts.to.key,
        lamports,
