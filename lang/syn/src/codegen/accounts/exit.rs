...
pub fn generate(accs: &AccountsStruct) -> proc_macro2::TokenStream {
    ...
    let on_save: Vec<proc_macro2::TokenStream> = accs
        ...
        .map(|af: &AccountField| match af {
            AccountField::CompositeField(s) => {
                ...
                quote! {
                    trezoaanchor-lang::AccountsExit::exit(&self.#name, program_id)
                ...
                if f.constraints.is_close() {
                    ...
                    quote! {
                        {
                            ...
                            trezoaanchor-lang::AccountsClose::close(
                                &self.#ident,
                    ...
                    match f.constraints.is_mutable() {
                        ...
                        true => match &f.ty {
                            ...
                            _ => quote! {
                                trezoaanchor-lang::AccountsExit::exit(&self.#ident, program_id)
                                    .map_err(|e| e.with_account_name(#name_str))?;
                            },
                        },
                    }
    ...
    quote! {
        ...
        impl<#combined_generics> trezoaanchor-lang::AccountsExit<#trait_generics> for #name<#struct_generics> #where_clause{
            fn exit(&self, program_id: &trezoaanchor-lang::trezoa_program::pubkey::Pubkey) -> trezoaanchor-lang::Result<()> {
                #(#on_save)*
                Ok(())
            }
        }
