use trezoaanchor_client::{Client, Cluster};
use anyhow::Result;
use clap::Parser;
...
use trezoa_system_interface::program as system_program;
...
pub fn main() -> Result<()> {
    ...
    let payer = read_keypair_file(&*shellexpand::tilde("~/.config/trezoa/id.json"))
