...
//!
//! This program is intended to implement the TPL Transfer Hook interface,
//! thus allowing Token2022 to call into this program when a transfer occurs.
//!
//! <https://spl.trezoa.com/token-2022/extensions#transfer-hook>

use {
    trezoaanchor-lang::prelude::*,
    trezoaanchor_spl::{
        token_2022::{
            spl_token_2022::{
                extension::{
...
pub mod transfer_hook {
    ...
    #[instruction(discriminator = InitializeExtraAccountMetaListInstruction::TPL_DISCRIMINATOR_SLICE)]
    pub fn initialize(ctx: Context<Initialize>, metas: Vec<TrezoaAnchorExtraAccountMeta>) -> Result<()> {
    ...
    #[instruction(discriminator = ExecuteInstruction::TPL_DISCRIMINATOR_SLICE)]
...
#[derive(Accounts)]
#[instruction(metas: Vec<TrezoaAnchorExtraAccountMeta>)]
...
pub struct TrezoaAnchorExtraAccountMeta {
    pub discriminator: u8,
    pub address_config: [u8; 32],
    pub is_signer: bool,
    pub is_writable: bool,
}
impl From<TrezoaAnchorExtraAccountMeta> for ExtraAccountMeta {
    fn from(meta: TrezoaAnchorExtraAccountMeta) -> Self {
        Self {
