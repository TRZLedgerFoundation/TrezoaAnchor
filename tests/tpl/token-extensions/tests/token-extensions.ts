...
import { ASSOCIATED_PROGRAM_ID } from "@trezoa-xyz/trezoaanchor/dist/cjs/utils/token";
...
describe("token extensions", () => {
  ...
  const program = trezoaanchor.workspace.TokenExtensions as Program<TokenExtensions>;
  ...
  it("Create mint account test passes", async () => {
    const [extraMetasAccount] = PublicKey.findProgramAddressSync(
      [
        trezoaanchor.utils.bytes.utf8.encode("extra-account-metas"),
