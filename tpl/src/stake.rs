use trezoaanchor-lang::{
    context::CpiContext,
    trezoa_program::{account_info::AccountInfo, pubkey::Pubkey},
    Accounts, Result,
};
use borsh::BorshDeserialize;
use trezoa_stake_interface::{
    self as stake,
    program::ID,
...
pub fn authorize<'info>(
    ...
    trezoaanchor-lang::trezoa_program::program::invoke_signed(&ix, &account_infos, ctx.signer_seeds)
        .map_err(Into::into)
}
...
impl trezoaanchor-lang::AccountDeserialize for StakeAccount {
...
impl trezoaanchor-lang::AccountSerialize for StakeAccount {}

impl trezoaanchor-lang::Owner for StakeAccount {
    fn owner() -> Pubkey {
        ID
    }
}
...
impl trezoaanchor-lang::Id for Stake {
    fn id() -> Pubkey {
        ID
    }
}
