...
pub fn initialize_mint2<'info>(
    ...
    trezoaanchor-lang::trezoa_program::program::invoke_signed(&ix, &[ctx.accounts.mint], ctx.signer_seeds)
        .map_err(Into::into)
}
...
impl trezoaanchor-lang::Owner for TokenAccount {
    fn owner() -> Pubkey {
        ID
    }
}
...
impl trezoaanchor-lang::Id for Token {
    fn id() -> Pubkey {
        ID
    }
}
