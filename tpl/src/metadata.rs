use trezoaanchor-lang::context::CpiContext;
use trezoaanchor-lang::error::ErrorCode;
use trezoaanchor-lang::trezoa_program::account_info::AccountInfo;
use trezoaanchor-lang::trezoa_program::pubkey::Pubkey;
use trezoaanchor-lang::{system_program, Accounts, Result, ToAccountInfos};
use std::ops::Deref;
...
impl trezoaanchor-lang::AccountDeserialize for MetadataAccount {
...
impl trezoaanchor-lang::AccountSerialize for MetadataAccount {}

impl trezoaanchor-lang::Owner for MetadataAccount {
    fn owner() -> Pubkey {
        ID
    }
}
...
impl trezoaanchor-lang::AccountDeserialize for MasterEditionAccount {
    fn try_deserialize(buf: &mut &[u8]) -> trezoaanchor-lang::Result<Self> {
...
impl trezoaanchor-lang::AccountSerialize for MasterEditionAccount {}

impl trezoaanchor-lang::Owner for MasterEditionAccount {
    fn owner() -> Pubkey {
        ID
    }
}
...
impl trezoaanchor-lang::AccountDeserialize for TokenRecordAccount {
    fn try_deserialize(buf: &mut &[u8]) -> trezoaanchor-lang::Result<Self> {
...
impl trezoaanchor-lang::AccountSerialize for TokenRecordAccount {}

impl trezoaanchor-lang::Owner for TokenRecordAccount {
    fn owner() -> Pubkey {
        ID
    }
}
...
impl trezoaanchor-lang::Id for Metadata {
    fn id() -> Pubkey {
        ID
    }
}
